...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = 660769042;
    ...
    /**
     * The column <code>library.users.first_name</code>.
     */
    ...
    /**
     * The column <code>library.users.last_name</code>.
     */
     ...
     */
    public final TableField<UsersRecord, String> EMAIL = createField("email", org.jooq.impl.SQLDataType.VARCHAR.length(45).nullable(false), this, "");

    /**
     * The column <code>library.users.is_active</code>.
     */
    public final TableField<UsersRecord, Byte> IS_ACTIVE = createField("is_active", org.jooq.impl.SQLDataType.TINYINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.TINYINT)), this, "");
